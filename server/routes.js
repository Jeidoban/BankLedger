...
module.exports = function (app) {
    ...
    app.post('/bank-ledger/api/createUser', (req, res) => {
    ...
    app.post('/bank-ledger/api/login', (req, res) => {
    ...
    app.post('/bank-ledger/api/getBalance', (req, res) => {
    ...
    app.put('/bank-ledger/api/makeDeposit', (req, res) => {
        let user = db.checkToken(req.body.id, req.body.token);
    ...
    app.put('/bank-ledger/api/makeWithdrawl', (req, res) => {
        let user = db.checkToken(req.body.id, req.body.token);
